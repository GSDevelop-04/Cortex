...
function depart(){
	...
	for (var i=0; i<nbVoiture; i=i+1){
        ...
        listeVoitures[i] = new voiture(xDepart, yDepart, tetaDepart, 3,0, coefs, imgVoiture);
	}	
    topDepart=true;
}
function nouvelleGeneration() {
	...
	coefs[1]=c1;
	coefs[2]=c2;
	listeVoitures[0] = new voiture(xDepart, yDepart, tetaDepart , 3,0, coefs, imgVoiture);
